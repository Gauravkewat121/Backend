...
// console.log("india-time--->",time.format('LT'));   // india-time---> 10:00 AM

// console.log("london-time--->",time.tz('Europe/London').format('LT'))  // london-time---> 4:30 AM

// console.log("new_york-time--->",time.tz('America/New_York').format('LT')) // new_york-time---> 12:30 AM

// console.log('tz.guess===>',moment.tz.guess())
// console.log(time.guess()) // not supported


// console.log('tz--',moment.tz('Asia/Kolkata'));

// console.log("moment()", moment());

// Example: Web app default timezone
// moment.tz.setDefault("America/New_York");

// console.log(moment())
//console.log(moment.utc("2026-03-20 09:00"))


// Create multiple moments without specifying timezone every time

// let time = moment.utc(new Date()).tz('Asia/Kolkata');
// console.log('new york',time.tz('America/New_York'));
// console.log('india',time);
// console.log('london',time.tz('Europe/London'));

// console.log(moment.tz.guess());
// //console.log(moment.tz.names());
// console.log(moment.tz.zone('Asia/Kokata'));
...
function sayHi() {
  ...
  var phrase;
  console.log(phrase);
  console.log(global.phrase)
  console.log(globalThis.phrase);
  console.log(x);
